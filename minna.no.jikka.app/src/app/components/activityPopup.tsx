            ...
            {type === "main" ? (
                <AnimationWrapper animationType='fade-up'>
                    <div className="w-[80vw] lg:w-[23vw] h-auto bg-white lg:bg-gray-100 rounded-3xl shadow flex flex-row lg:flex-col items-center group hover:-translate-y-1 duration-500 hover:shadow-lg z-0">
                        <div className="ml-12 lg:ml-0 text-left lg:text-center w-16 h-16 lg:w-52 lg:h-52 bg-zinc-300 my-3 lg:my-10" />
                        <div className="ml-6 lg:ml-0 lg:w-52 lg:h-16 items-center">
                            ...
                            <p className="text-left lg:text-center text-orange-300 text-xs lg:text-sm leading-tight">{content.pjName_Eng}</p>
                        </div>
                    </div>
                </AnimationWrapper>
            ) : (
                <AnimationWrapper animationType='scale-in-center'>
                    <div className="w-[35vw] lg:w-[23vw] h-auto lg:h-24 bg-white lg:bg-gray-100 rounded-lg lg:rounded-3xl shadow flex flex-col lg:flex-row items-center group hover:-translate-y-1 duration-500 hover:shadow-lg z-0">
                        <div className='lg:ml-12 w-10 h-10 bg-zinc-300'></div>
                        <div className='lg:ml-6 items-center'>
                            ...
                            <div className="hidden lg:block w-4/5 h-px my-1 bg-gray-700 relative group-hover:w-full transition-all duration-700 ease-in-out before:absolute before:content-[''] before:rounded-full before:w-1 before:h-1 before:bg-gray-700 before:top-1/2 before:left-0 before:-translate-y-1/2 after:absolute after:content-[''] after:rounded-full after:w-1 after:h-1 after:bg-gray-700 after:top-1/2 after:right-0 after:-translate-y-1/2" />
                            <p className="hidden lg:block text-orange-300 text-sm">{content.pjName_Eng}</p>
                        </div>
                    </div>
                </AnimationWrapper>
            )}
