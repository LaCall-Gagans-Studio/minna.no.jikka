...
const ChairmanInfo = () => {
    ...
    return(
        <div className="Relation-Leader flex flex-col items-center mt-12 mb-6 lg:mb-0 w-full">
            ...
            <div className={`duration-600 transition-all w-full flex flex-col items-center z-0 ${isOpen ? 'translate-y-0 h-auto opacity-100' : '-translate-y-[100%] h-0 opacity-0'} lg:translate-y-0 lg:h-auto lg:opacity-100`}>
                <div className="flex mt-6 flex-col lg:flex-row">
                    <div className="flex flex-col items-center">
                        <img className="w-96 h-full object-cover" src="./images/index_relation_chairman.webp" />
                        <h3 className="text-center text-black text-xl font-light leading-loose mt-2">津村 雄一 / Yuichi Tsumura</h3>
                        <h4 className="lg:text-left lg:ml-1 text-neutral-400 text-lg font-light leading-tight mt-2">生い立ち</h4>
                        ...
                        <h4 className="lg:ml-1 lg:text-left text-neutral-400 text-lg font-light leading-tight mt-2">好きな言葉</h4>
                    ...
                    <div className="mt-6 lg:mt-0 ml-3 lg:ml-8 items-center">
                        <h3 className="text-neutral-400 text-sm lg:text-xl font-light leading-loose">代表からのメッセージ</h3>
